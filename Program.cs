...
internal class NewBaseType
{
    ...
    {
        int[] myArrey = { 3, 4, 456, 6, 49, 65, 111, 1, 77 };

        Console.WriteLine(myArrey.Max());
...
*/
/*
// Найти минимальное число массива.
...
internal class NewBaseType
{
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine(myArrey. Where(i => i % 2 == 0).Sum());
...
*/
/*
// Найти наименьшее нечётное число элементов  массива.
...
internal class NewBaseType
{
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine(myArrey. Where(i => i % 2 != 0).Min());
...
*/
/*
// Найти уникальные числа массива и поместить их в другой массив.

internal class NewBaseType
{
    private static void Main(string[] args)
    {
         int[] myArrey = { 3, 4, 456, 111, 49, 65, 111, 4, 77, 65 };

         int[] result = myArrey.Distinct().ToArray();
...
internal class NewBaseType
{
    private static void Main(string[] args)
    {
        ...
        int v = Array.Find(myArrey, i => i < 70);
